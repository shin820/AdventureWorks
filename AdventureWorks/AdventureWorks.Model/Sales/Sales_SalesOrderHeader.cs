...
namespace AdventureWorks.Model.Sales
{
    public class Sales_SalesOrderHeader
    {
        ...
        public virtual Address Address { get; set; } //  BillToAddressId - FK_SalesOrderHeader_Address_BillToAddressID
        public virtual Address Address1 { get; set; } //  ShipToAddressId - FK_SalesOrderHeader_Address_ShipToAddressID
