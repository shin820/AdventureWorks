...
{
    internal class HumanResources_EmployeeAddressConfiguration : EntityTypeConfiguration<HumanResources_EmployeeAddress>
    {
        public HumanResources_EmployeeAddressConfiguration()
        {
            ...
            // Foreign keys
            HasRequired(a => a.HumanResources_Employee).WithMany(b => b.HumanResources_EmployeeAddress).HasForeignKey(c => c.EmployeeId); // FK_EmployeeAddress_Employee_EmployeeID
